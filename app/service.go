...
func StartService(params ServiceParams) {
	...
	startSigsMonitor(ch_stop, params.UseDiscovery)
	startJobsManager(ch_req)
	initializeMetricService(params)
	startDiscovery(params, myAddress)
	if params.UseDiscovery {
		registerToDiscovery(params, myAddress)
	}
...
func startDiscovery(params ServiceParams, myAddress string) {
	var err error
...
func registerToDiscovery(params ServiceParams, myAddress string) {
	var err error
...
func startSigsMonitor(ch_stop chan struct{}, useDiscovery bool) {
	go sigsMonitor(ch_stop, useDiscovery)
}

func sigsMonitor(ch_stop chan struct{}, useDiscovery bool) {
